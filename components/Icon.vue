...
<template>
  ...
  <svg
    ...
    viewBox="0 0 80 80"
  >
    <g stroke="#0891B2" stroke-width="5" clipPath="url(#clip0_1_1478)">
      <path stroke-linecap="round" d="M73.3 73.3H6.7" />
      <path
        stroke-opacity="0.5"
    ...
    <defs>
      <clipPath id="clip0_1_1478">
        <rect width="80" height="80" fill="#fff" rx="16.6" />
      </clipPath>
    </defs>
  </svg>
  ...
  <svg
    ...
    viewBox="0 0 80 80"
  >
    <g stroke="#0891B2" stroke-width="5" clipPath="url(#clip0_1_1492)">
      <path stroke-opacity="0.5" d="M26.7 26.7h26.6v26.6H26.7V26.7z" />
      <path
        d="M53.3 53.3h10a10 10 0 11-10 10v-10zM26.7 53.3h-10a10 10 0 1010 10v-10zM53.3 26.7h10a10 10 0 10-10-10v10zM26.7 26.7h-10a10 10 0 1110-10v10z"
      />
    </g>
    <defs>
  ...
  <svg
    ...
    viewBox="0 0 80 80"
  >
    <g stroke="#0891B2" stroke-width="5" clipPath="url(#clip0_1_1501)">
      <path
